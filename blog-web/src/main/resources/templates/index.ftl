...
<@compress single_line=true>
    <@header title="${config.siteName?if_exists}" keywords="${config.homeKeywords?if_exists}" description="${config.homeDesc?if_exists}" canonical="/${url?if_exists}">
    </@header>
                ...
                <div class="scrolltext">
                    <ul class="list-unstyled" id="notice-box">
                        <li class="scrolltext-title">
                            <a href="javascript:void(0)" rel="bookmark">Blog:<a href="#" target="_blank"><strong>Blog</strong></a></a>
                        </li>
                        <li class="scrolltext-title">
                            <a href="javascript:void(0)" rel="bookmark">Hello</a>
                        </li>
                        <li class="scrolltext-title">
                            <a href="javascript:void(0)" rel="bookmark">World</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <article class="fade-in" style="height: auto">
                        <div class="rows">
                            <div class="col-md-10 col-sm-12">
                                <div class="h3 text-center">服务器开小差了<img src="http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/15/j_thumb.gif" alt="[囧]"></div>
                                <div class="h5 text-center">请重试</div>
                            </div>
                        ...
                        <form action="/" method="post" class="form-horizontal searchForm">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control br-none" name="keywords" placeholder="请重试">
